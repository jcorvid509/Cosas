# Cosas interesantes que encuentro
...
- ### Cyber-seguridad: [Hacknet](https://store.steampowered.com/app/365450/Hacknet/)
- ### Linux: [Over the wire war games](https://overthewire.org/wargames/)
- ### Redes: [Tunnet](https://store.steampowered.com/app/2286390/Tunnet/)
- ### Python: [The farmer was replaced](https://store.steampowered.com/app/2060160/The_Farmer_Was_Replaced/)
- ### C++: [Codewars](https://www.codewars.com/)
- ### SQL: [SQL island](https://sql-island.informatik.uni-kl.de/)
- ### Java: [Coding Game](https://www.codingame.com/start/)
- ### Javascript: [Code Combat](https://codecombat.com/)
